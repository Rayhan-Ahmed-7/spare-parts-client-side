...
const Header = () => {
    ...
    //FFCB00 = yellow
    return (
        <header className='bg-[#383264] h-20 flex items-center bg-opacity-40 backdrop-blur-md sticky top-0 z-50'>
