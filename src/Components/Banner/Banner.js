        ...
        <div className="min-h-[90vh] bg-banner-image bg-cover">
            <div className='lg:w-10/12 w-11/12 mx-auto flex min-h-[80vh] items-center'>
                <div className='text-white flex-1'>
                    ...
                    <h2 className='md:text-5xl text-3xl font-bold md:mt-4 mt-2 font-title tracking-[.2rem]'>WE PROVIDE PREMIUM<br /><span className='text-primary'> QUALITY CAR SPARE PARTS</span></h2>
